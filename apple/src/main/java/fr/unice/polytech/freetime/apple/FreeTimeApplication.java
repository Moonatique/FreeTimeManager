package fr.unice.polytech.freetime.apple;
...
public class FreeTimeApplication extends Application {
    ...
    public static final String PREFNAME = "freetime_prefs";
    public static final String PREF_FREETIME_CAL_ID = "freetime_cal_id";
    ...
    public FreeTimeCalendarService getFtcService() { return ftcService; }
}
